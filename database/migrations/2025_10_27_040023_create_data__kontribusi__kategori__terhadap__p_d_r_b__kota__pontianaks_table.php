...
return new class extends Migration
{
    ...
    {
        Schema::create('data__kontribusi__kategori__terhadap__p_d_r_b__kota__pontianaks', function (Blueprint $table) {
            $table->id();
            $table->integer('Tahun');
    ...
    {
        Schema::dropIfExists('data__kontribusi__kategori__terhadap__p_d_r_b__kota__pontianaks');
    }
};
