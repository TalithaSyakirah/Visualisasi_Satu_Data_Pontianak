...
class DataPertumbuhanNilaiTambahKategoriKotaPontianakController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        Data_Pertumbuhan_Nilai_Tambah_Kategori_Kota_Pontianak::create($request->all());
